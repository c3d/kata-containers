...
use protocols::agent::{
    AddSwapRequest, AgentDetails, CopyFileRequest, GuestDetailsResponse, Interfaces,
    ListProcessesResponse, Metrics, OOMEvent, ReadStreamResponse, Routes, StatsContainerResponse,
