...
var listCLICommand = cli.Command{
	Name:  "list",
	Usage: "lists containers started by " + katautils.NAME + " with the given root",
	ArgsUsage: `

Where the given root is specified via the global option "--root"
(default: "` + katautils.DEFAULTROOTDIRECTORY + `").
...
To list containers created using a non-default value for "--root":
       # ` + katautils.NAME + ` --root value list`,
	Flags: []cli.Flag{
		cli.StringFlag{
			Name:  "format, f",
			Value: "table",
		...
		cli.BoolFlag{
			Name:  "kata-all",
			Usage: "display all available " + katautils.PROJECT + " information",
		},
	},
